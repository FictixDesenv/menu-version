    ...
    >
      <div className="flex flex-col items-center">
        ...
        <button
          ...
          className="w-full max-w-xs rounded-full py-4 text-lg font-semibold text-primary-foreground shadow-lg bg-primary hover:bg-primary/90 hover:shadow-xl hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 ease-in-out animate-[pulse_3s_ease-in-out_infinite]"
        >
          Toque para começar
        </button>
      </div>
